...
public class PlayerData : ScriptableObject
{
	...
	[Space(5)]
	[Tooltip("Bảo toàn quán tính trên không. Nếu nhân vật đang bay nhanh hơn runMaxSpeed theo đúng hướng input, sẽ không bị giảm tốc — chỉ có tác dụng khi rời mặt đất (không áp dụng lúc đang chạy trên mặt đất).")]
	...
	[Tooltip("Thời gian nhân vật vẫn ở trạng thái nhảy tường.\nTrong khoảng này, độ bẻ lái ngang bị giới hạn theo wallJumpRunLerp ở trên.")]
