...
public class PlayerAttack : MonoBehaviour
{
    ...
    [Header("Camera")]
    [Tooltip("Kéo thẳng GameObject 'Main Camera' trên thẻ Hierarchy vào ô này. Dùng để tính tọa độ ngắm bắn ngang theo chuột.")]
    [SerializeField] private Camera _mainCamera;

    [Header("References")]
    [SerializeField] private Transform _firePoint;      // FirePoint child — điểm spawn đạn
    [SerializeField] private BulletPool _bulletPool;     // Kéo BulletPool từ Scene vào đây
