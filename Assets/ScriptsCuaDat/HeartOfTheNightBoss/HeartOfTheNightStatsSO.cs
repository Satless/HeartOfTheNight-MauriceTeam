...
namespace HeartOfTheNight.Enemy
{
    ...
    public class HeartOfTheNightStatsSO : ScriptableObject
    {
        ...
        [Range(0.05f, 1f)] public float enrageHealthFraction = 0.45f;
        [Tooltip("Nho hon = tan cong nhanh hon khi enrage.")]
        [Range(0.2f, 1f)] public float enrageSpeedMultiplier = 0.55f;
        public int enrageExtraBarrageWaves = 2;
        public int enrageExtraLaserVolleys = 1;
        public bool enrageDisableLaserSafeGap = true;
        public int enrageExtraPillars = 1;
        [Min(1f)] public float enrageBulletSpeedMul = 1.25f;
        ...
        public float[] attackWeights = { 1f, 1.35f, 1.25f, 0.8f };
        ...
        public float barrageBetweenShots = 0.12f;
        public float barrageSpreadAngle = 14f;
        public float bulletSpeed = 13f;
        public int bulletDamage = 14;
        ...
        public float laserWarnTime = 0.7f;
        public float laserFireTime = 0.4f;
        public float laserLength = 30f;
        public float laserWidth = 0.8f;
        public int laserDamage = 14;
        public float eightDirCooldown = 4.5f;

        [Header("State 3 - Fire Pillar (Cot lua)")]
        public float pillarCooldown = 3.5f;
        public float pillarChargeTime = 1.15f;
        public bool pillarFollowPlayer = true;
        public float pillarLockLeadTime = 0.38f;
        public float pillarFireTime = 0.7f;
        public float pillarWidth = 1.85f;
        public float pillarHeight = 18f;
        public int pillarDamage = 28;
        ...
        public int maxActiveSummons = 8;
        public float summonScatterRadius = 4f;
        public float summonCooldown = 7.5f;
